...
var SimpleProblemBuilder = (function () {
    ...
    SimpleProblemBuilder.prototype.createOptions = function (solution) {
        var options = [
            new models_1.MatesNumber(solution.dividend - 1, solution.divisor, false),
            new models_1.MatesNumber(solution.dividend - 2, solution.divisor, false),
            new models_1.MatesNumber(solution.dividend - 3, solution.divisor, false),
            new models_1.MatesNumber(solution.dividend + 1, solution.divisor, false),
            new models_1.MatesNumber(solution.dividend + 2, solution.divisor, false),
            new models_1.MatesNumber(solution.dividend + 3, solution.divisor, false),
            new models_1.MatesNumber(solution.dividend, solution.divisor, !solution.sign)
        ];
        return this.shuffle(options).slice(0, 5);
    };
